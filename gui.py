...
class Gui(tk.Frame):
    ...
    def mainMenu(self):
        ...
        additionBtn = tk.Button(self.master, text="addition", command=lambda: self.quizChoice("1"))
    ...
    def quizChoice(self, quiz):
        ...
        for question in questions:
            ...
            while nextLevel != 1:
                ...
                self.ansBtn1 = tk.Button(self.master, text=question[3], command=lambda: ans.set(3))
                self.ansBtn1.grid(row=1, column=0)

                self.ansBtn2 = tk.Button(self.master, text=question[4], command=lambda: ans.set(4))
                self.ansBtn2.grid(row=1, column=1)

                self.ansBtn3 = tk.Button(self.master, text=question[5], command=lambda: ans.set(5))
                self.ansBtn3.grid(row=2, column=0)

                self.ansBtn4 = tk.Button(self.master, text=question[6], command=lambda: ans.set(6))
                self.ansBtn4.grid(row=2, column=1)

                self.ok = tk.Button(self.master, text="Submit answer", command=lambda: nextlevel.set(1))
